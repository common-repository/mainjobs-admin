...
class CCA_WPAdmin {
	...
	public function custom_login_logo() {
		...
		h1 a { background-image:url(' . esc_url( trailingslashit( plugin_dir_url( __FILE__ ) ) ) . 'logo-login.svg) !important; width: 300px !important; background-size: 300px !important; }
		body.login {background: #0E1E3E; }
		.login label {color:#0E1E3E;}
		.login form { background: white; border: 3px solid #0E1E3E;}
		.wp-core-ui .button-primary {background-color: #0E1E3E; border-color: #0E1E3E;}
		.wp-core-ui .button-primary.focus, .wp-core-ui .button-primary.hover, .wp-core-ui .button-primary:focus, .wp-core-ui .button-primary:hover {  background-color: #0E1E3E;border-color: #0E1E3E; }
	...
	public function change_bar_color() {
		...
		echo '<style>
			...
			.wc-install.ultp-pro-notice, .license-warning.notice.notice-error.is-dismissible {	display: none; }#wpadminbar #wp-admin-bar-wp-logo>.ab-item {
				padding: 0;
				background-image: url( ' . esc_url( trailingslashit( plugin_dir_url( __FILE__ ) ) ) . '/logo-mini.svg) !important;
				background-size: 88%;
